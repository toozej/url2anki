// Package man provides manual page generation functionality for the url2anki application.
//
// This package creates Unix manual pages (man pages) for the url2anki CLI
...
// Example usage:
//
//	import "github.com/toozej/url2anki/pkg/man"
//
//	// Add man command to root command
//	rootCmd.AddCommand(man.NewManCmd())
//
//	// Generate man pages:
//	// ./url2anki man > url2anki.1
package man
...
// for the url2anki application. The command traverses the root command tree
